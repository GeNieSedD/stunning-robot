...
//   console.log("Полученный groupId:", groupId);
//   if (!groupId) {
//     res.status(400).json({ message: "Не указан ID" });
//   }

//   try {
//     const tests = await prisma.testTasks.findMany({
//       where: {
...
//       return res
//         .status(404)
//         .json({ message: "Тесты не найдены для данной группы" });
//     }

//     res.status(200).json({
//       message: "Тесты успешно созданы",
//       tests,
//     });
//   } catch (error) {
